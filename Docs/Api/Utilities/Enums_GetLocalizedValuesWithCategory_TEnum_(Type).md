...
```
#### Type parameters
<a name='EficazFramework_Extensions_Enums_GetLocalizedValuesWithCategory_TEnum_(System_Type)_TEnum'></a>
`TEnum`  
  
#### Parameters
<a name='EficazFramework_Extensions_Enums_GetLocalizedValuesWithCategory_TEnum_(System_Type)_resourceType'></a>
