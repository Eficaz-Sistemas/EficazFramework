...
## NumberExtensions.ToWords(double, Gender) Method
...
```
#### Parameters
<a name='EficazFramework_Extensions_NumberExtensions_ToWords(double_EficazFramework_Extensions_NumberExtensions_Gender)_number'></a>
`number` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')  
O número a ser escrito.
  
<a name='EficazFramework_Extensions_NumberExtensions_ToWords(double_EficazFramework_Extensions_NumberExtensions_Gender)_gender'></a>
