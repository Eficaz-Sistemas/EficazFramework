...
| [GetRequestMode](EficazFramework.Repositories/ApiRepository_TEntity_/GetRequestMode.md 'EficazFramework.Repositories.ApiRepository<TEntity>.GetRequestMode') | Permite parametrizar se a requição para obtenção de dados será GET ou POST |
