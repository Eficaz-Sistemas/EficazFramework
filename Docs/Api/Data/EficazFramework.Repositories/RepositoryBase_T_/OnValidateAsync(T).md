...
## RepositoryBase<T>.OnValidateAsync(T) Method

```csharp
public virtual System.Threading.Tasks.Task<EficazFramework.Validation.Fluent.ValidationResult> OnValidateAsync(T instance);
```
#### Parameters

<a name='EficazFramework.Repositories.RepositoryBase_T_.OnValidateAsync(T).instance'></a>
