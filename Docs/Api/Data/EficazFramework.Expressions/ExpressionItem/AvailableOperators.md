...
## ExpressionItem.AvailableOperators Property

```csharp
public System.Collections.Generic.IEnumerable<EficazFramework.Extensions.EnumMember> AvailableOperators { get; set; }
```
