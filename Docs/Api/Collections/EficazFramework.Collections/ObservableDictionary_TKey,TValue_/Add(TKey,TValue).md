...
## ObservableDictionary<TKey,TValue>.Add(TKey, TValue) Method
...
<a name='EficazFramework.Collections.ObservableDictionary_TKey,TValue_.Add(TKey,TValue).key'></a>
...
<a name='EficazFramework.Collections.ObservableDictionary_TKey,TValue_.Add(TKey,TValue).value'></a>
