...
<a name='EficazFramework.Providers.SqlLite.OnConfiguring(DbContextOptionsBuilder,string,string,string).optionsBuilder'></a>
...
<a name='EficazFramework.Providers.SqlLite.OnConfiguring(DbContextOptionsBuilder,string,string,string).database'></a>

`database` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='EficazFramework.Providers.SqlLite.OnConfiguring(DbContextOptionsBuilder,string,string,string).username'></a>

`username` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

<a name='EficazFramework.Providers.SqlLite.OnConfiguring(DbContextOptionsBuilder,string,string,string).password'></a>
