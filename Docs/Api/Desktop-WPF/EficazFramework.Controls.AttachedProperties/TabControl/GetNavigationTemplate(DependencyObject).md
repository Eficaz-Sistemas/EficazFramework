...
## TabControl.GetNavigationTemplate(DependencyObject) Method

```csharp
public static bool GetNavigationTemplate(System.Windows.DependencyObject element);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.TabControl.GetNavigationTemplate(System.Windows.DependencyObject).element'></a>
