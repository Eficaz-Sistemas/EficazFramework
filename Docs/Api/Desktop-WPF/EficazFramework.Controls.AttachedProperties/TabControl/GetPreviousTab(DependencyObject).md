...
## TabControl.GetPreviousTab(DependencyObject) Method

```csharp
public static System.Nullable<int> GetPreviousTab(System.Windows.DependencyObject element);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.TabControl.GetPreviousTab(System.Windows.DependencyObject).element'></a>
