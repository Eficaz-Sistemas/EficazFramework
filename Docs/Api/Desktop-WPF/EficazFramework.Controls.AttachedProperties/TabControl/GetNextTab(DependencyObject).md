...
## TabControl.GetNextTab(DependencyObject) Method

```csharp
public static System.Nullable<int> GetNextTab(System.Windows.DependencyObject element);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.TabControl.GetNextTab(System.Windows.DependencyObject).element'></a>
