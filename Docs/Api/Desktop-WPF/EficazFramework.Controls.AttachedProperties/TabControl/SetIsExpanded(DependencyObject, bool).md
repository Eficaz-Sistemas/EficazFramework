...
## TabControl.SetIsExpanded(DependencyObject, bool) Method

```csharp
public static void SetIsExpanded(System.Windows.DependencyObject element, bool value);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.TabControl.SetIsExpanded(System.Windows.DependencyObject,bool).element'></a>
...
<a name='EficazFramework.Controls.AttachedProperties.TabControl.SetIsExpanded(System.Windows.DependencyObject,bool).value'></a>
