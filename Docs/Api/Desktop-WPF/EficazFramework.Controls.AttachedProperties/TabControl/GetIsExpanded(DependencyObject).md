...
```csharp
public static bool GetIsExpanded(System.Windows.DependencyObject element);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.TabControl.GetIsExpanded(System.Windows.DependencyObject).element'></a>
