...
## TabControl.SetNavigationTemplateShowTitle(DependencyObject, bool) Method

```csharp
public static void SetNavigationTemplateShowTitle(System.Windows.DependencyObject element, bool value);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.TabControl.SetNavigationTemplateShowTitle(System.Windows.DependencyObject,bool).element'></a>
...
<a name='EficazFramework.Controls.AttachedProperties.TabControl.SetNavigationTemplateShowTitle(System.Windows.DependencyObject,bool).value'></a>
