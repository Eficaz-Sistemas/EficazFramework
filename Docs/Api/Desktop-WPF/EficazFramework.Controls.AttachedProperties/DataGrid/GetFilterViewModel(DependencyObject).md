...
## DataGrid.GetFilterViewModel(DependencyObject) Method

```csharp
public static EficazFramework.Expressions.ExpressionBuilder GetFilterViewModel(System.Windows.DependencyObject obj);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.DataGrid.GetFilterViewModel(System.Windows.DependencyObject).obj'></a>
