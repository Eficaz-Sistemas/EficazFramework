...
## Selector.GetHideSelection(DependencyObject) Method

```csharp
public static bool GetHideSelection(System.Windows.DependencyObject element);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.Selector.GetHideSelection(System.Windows.DependencyObject).element'></a>
