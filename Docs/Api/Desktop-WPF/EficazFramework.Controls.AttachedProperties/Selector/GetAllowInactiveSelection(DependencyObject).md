...
## Selector.GetAllowInactiveSelection(DependencyObject) Method

```csharp
public static bool GetAllowInactiveSelection(System.Windows.DependencyObject element);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.Selector.GetAllowInactiveSelection(System.Windows.DependencyObject).element'></a>
