...
## Control.GetShowLabel(DependencyObject) Method

```csharp
public static bool GetShowLabel(System.Windows.DependencyObject element);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.Control.GetShowLabel(System.Windows.DependencyObject).element'></a>
