...
## Control.SetIsEmpty(DependencyObject, bool) Method

```csharp
public static void SetIsEmpty(System.Windows.DependencyObject element, bool value);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.Control.SetIsEmpty(System.Windows.DependencyObject,bool).element'></a>
...
<a name='EficazFramework.Controls.AttachedProperties.Control.SetIsEmpty(System.Windows.DependencyObject,bool).value'></a>
