...
## Control.SetShowLabel(DependencyObject, bool) Method

```csharp
public static void SetShowLabel(System.Windows.DependencyObject element, bool value);
```
#### Parameters

<a name='EficazFramework.Controls.AttachedProperties.Control.SetShowLabel(System.Windows.DependencyObject,bool).element'></a>
...
<a name='EficazFramework.Controls.AttachedProperties.Control.SetShowLabel(System.Windows.DependencyObject,bool).value'></a>
