...
Param (
 ...
 Process {
    ...
    Get-ProjectReleaseStatus -Projectname "EficazFramework.Data.PostgreSql" -SubFolder "\DataProviders"
...
Function Set-Versions {
 Process {
    ...
    Set-Version -Projectname "EficazFramework.Data.PostgreSql" -SubFolder "\DataProviders"
