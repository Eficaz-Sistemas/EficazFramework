...
class Number
{
    ...
    public void ToWords()
    {
        ...
        (412.ToWords(NumberExtensions.Currency.Real_BRL) ?? "").ToLower().Should().Be("quatrocentos e doze reais");
        ...
        (412.ToWords(NumberExtensions.Gender.Masculino) ?? "").ToLower().Should().Be("quatrocentos e doze");
        ...
        (412.ToWords(NumberExtensions.Gender.Feminino) ?? "").ToLower().Should().Be("quatrocentas e doze");
