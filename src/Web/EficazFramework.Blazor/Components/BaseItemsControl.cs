...
namespace EficazFrameworkCore.Components
{
    public abstract class BaseItemsControl<TChildComponent> : ComponentBase
    ...
    public abstract class BaseBindableItemsControl<TChildComponent, TData> : BaseItemsControl<TChildComponent>
        where TChildComponent : ComponentBase
    {
