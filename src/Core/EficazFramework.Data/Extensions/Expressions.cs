...
namespace EficazFramework.Extensions
{
    ...
    {
        private static MethodInfo ContainsMethod = typeof(string).GetRuntimeMethod("Contains", new[] { typeof(string) });
        ...
        {
            if (query is Extensions.ExpandableQuery<T>)
            {
                return (Extensions.ExpandableQuery<T>)query;
            }
